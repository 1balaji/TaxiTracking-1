...
public class Login extends Activity {
    ...
    String IP_Server="8.200.0.53:8084";//IP DE NUESTRO PC
    String URL_connect="http://"+IP_Server+"/LoginAndroid/Access";//ruta en donde estan nuestros archivos
    ...
    public boolean loginstatus(String username ,String password ) {
    	...
    	ArrayList<NameValuePair> postparameters2send= new ArrayList<NameValuePair>();
		    		...
		    		postparameters2send.add(new BasicNameValuePair("TBUsuario",username));
		    		postparameters2send.add(new BasicNameValuePair("TBContrasena",password));
