...
{
    final String CONSUMERKEY = "Cv9rHmBtAnxl3ESWsP5pJ97Po";
    final String CONSUMERSECRET = "mDj5yk4yOZgR8Ane4xgZKNu8QKGGwgpjOdQi0csJODIAbq97aB";
    ...
    //URL que se accede para pedir la autorizacion del programa
    String url = null;
    ...
    ConexionTwitter() throws IOException, TwitterException 
    {
        ...
        catch (IOException e) 
        {
            ...
            do 
            {
                ...
                catch (BrowserLaunchingInitializingException | UnsupportedOperatingSystemException be) { System.out.println("Error al abrir el navegador D:\n" + be); }
